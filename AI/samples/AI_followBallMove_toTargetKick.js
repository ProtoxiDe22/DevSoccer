 ...
 *					a random speed pointing to the ball.
...
function CustomPlayer(){
    ...
    this.turn = function(status){
        ...
        var turnActions = {
            player:{	//to the ball
                deltaSpeedX: this.selectMove(player.x, player.speedX, ball.x, 0, this.match.MAXX),
                deltaSpeedY: this.selectMove(player.y, player.speedY, ball.y, 0, this.match.MAXY)
            },
